export default {
  ...
  ENTRY_PATH_PLACEHOLDER: 'Type to search existing entries, or enter a new path',
  USERNAME: 'Username',
  PASSWORD: 'Password',
  URL: 'URL',
  NOTES: 'Notes',
  ...
  MISSING_ENTRY_DESC: 'Entry not found for reference: {entryPath}',
  ...
  DATABASE_PATH_DESC: 'Path to the .kdbx file, relative to this vault (e.g., Secrets/passwords.kdbx)',
  KEY_PATH: 'Key File Path (Optional)',
  KEY_PATH_DESC: 'Path to the key file, relative to this vault (optional)',
  READ_ONLY: 'Read-Only',
  ...
  // KdbxService errors
  ERR_DB_NOT_FOUND: 'Database file not found in vault: {path}',
  ERR_KEYFILE_NOT_FOUND: 'Key file not found in vault: {path}',
